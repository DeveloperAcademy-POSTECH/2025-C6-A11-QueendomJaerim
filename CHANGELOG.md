...
- 친구 연결 화면의 뒤로가기 버튼이 역할과 연결 시도를 초기화하고 역할 선택 화면으로 이동하도록 수정
...
- 역할 선택 화면 V2의 상태·레이아웃·전환·현지화 UI 단위 테스트 추가
- 친구 연결 화면 V2의 상태·콜백·레이아웃 UI 단위 테스트 추가
...
- 메인 앱 모듈의 친구 연결 화면 V2 UI 테스트 전용 진입점 제거
