...
struct WifiAwareGuide {
  ...
  static let photographerGuides: [Self] = [
    .init(
      message: highlighted(
        original: AttributedString(String(localized: "‘주변 기기 찾기’를 시작하고\n잠시 기다려주세요.")),
    ...
    .init(
      message: highlighted(
        original: AttributedString(String(localized: "6자리 코드가 나오면\n친구에게 코드를 알려주세요.")),
    ...
    .init(
      message: highlighted(
        original: AttributedString(String(localized: "이 화면이 뜨면 등록 완료에요.\n창을 닫으면 연결 준비 완료!")),
  ...
  static let modelGuides: [Self] = [
    .init(
      message: highlighted(
        original: highlighted(
          original: AttributedString(String(localized: "‘주변 기기 찾기’를 시작해\n친구에게 페어링을 요청해주세요.")),
          target: String(localized: "‘주변 기기 찾기’"),
          color: .modelPrimary
        ),
    ...
    .init(
      message: highlighted(
        original: AttributedString(String(localized: "친구가 알려주는\n6자리 코드를 입력해주세요.")),
