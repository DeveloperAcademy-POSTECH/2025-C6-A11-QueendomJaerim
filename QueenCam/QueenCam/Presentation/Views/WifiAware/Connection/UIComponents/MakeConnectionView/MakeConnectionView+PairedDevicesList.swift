...
#Preview {
  ZStack {
    ...
    MakeConnectionView.PairedDevicesList(
      pairedDevices: [
        .init(device: createTestDevice(id: 0, name: "임영폰")!, isNew: true),
        .init(device: createTestDevice(id: 1, name: "루크폰")!, isNew: false),
        .init(device: createTestDevice(id: 2, name: "보타폰")!, isNew: false),
        .init(device: createTestDevice(id: 3, name: "요시폰")!, isNew: false),
        .init(device: createTestDevice(id: 4, name: "페퍼폰")!, isNew: false),
        .init(device: createTestDevice(id: 5, name: "차차폰")!, isNew: false),
        .init(device: createTestDevice(id: 6, name: "섭섭폰")!, isNew: false),
        .init(device: createTestDevice(id: 7, name: "하워드폰")!, isNew: false)
      ],
      isPairing: false,
      isConnected: false,
      selectedDevice: nil
